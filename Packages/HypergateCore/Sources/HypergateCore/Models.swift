...
public enum CoreError: Error, Equatable, Sendable, CustomStringConvertible {
  ...
  public var description: String {
    ...
    case .unsupportedDate:
      return "Date outside the calculation window 2000-01-01 through 2050-12-31 UTC."
...
public enum ZodiacSign: Int, CaseIterable, Codable, Sendable {
  case aries, taurus, gemini, cancer, leo, virgo, libra, scorpio, sagittarius, capricorn, aquarius,
    pisces
...
public struct ProviderMetadata: Codable, Sendable, Equatable {
  ...
  public init(
    name: String, revision: String, convention: String, earliest: Date, latestExclusive: Date
  ) {
    self.name = name
